	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<!-- Contact Info -->
				<div class="col-lg-6">
					<div class="section_title"><h2>Queremos escucharte </h2></div>
					<div class="contact_text" style="text-align: justify;
					text-justify: inter-word;">
						<p>Si requieres información de alguno de nuestros servicios o tienes alguna consulta que hacernos por favor rellena el formulario y uno de nuestros Medicos Especialistas se pondrá en contacto contigo lo antes posible.</p>
					</div>
					<ul class="contact_about_list">
						<li><div class="contact_about_icon"><img src="images/phone-call.svg" alt=""></div><span>33100-17488 y 33100-17489</span></li>
						<li><div class="contact_about_icon"><img src="images/envelope.svg" alt=""></div><span>contacto@fisioterapiahawaii.com</span></li>
						<li><div class="contact_about_icon"><img src="images/placeholder.svg" alt=""></div><span>Hawaii 1679, Colonia Niños Héroes <br> C.P. 44260, Guadalajara, Jalisco. México</span></li>
					</ul>
				</div>
                ...
                ?>
								...
								<div class="col-md-6 input_col">
									<div class="input_container input_name">
										<input id="nombre" type="text" name="Nombre" class="contact_input" placeholder="Nombre" required="required">
									</div>
								</div>
								<div class="col-md-6 input_col">
									<div class="input_container"><input type="email" name="Email" class="contact_input" placeholder="Email" required="required"></div>
								</div>
							</div>
							<div class="input_container"><input type="text" name="Asunto" class="contact_input" placeholder="Asunto" required="required"></div>
							<div class="input_container"><textarea name="Mensaje" class="contact_input contact_text_area" placeholder="Mensaje" required="required"></textarea></div>
						...
						<div class="map">
							<div id="google_map" class="google_map">
								<div class="map_container">
									<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14928.82764841134!2d-103.3599471!3d20.7018208!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x423a74f0557fb037!2sCentro%20M%C3%A9dico%20Hawaii!5e0!3m2!1sen!2suk!4v1603466548170!5m2!1sen!2suk" width="1200" height="550" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
									<div id="map"></div>
								</div>
							</div>
						</div>
...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCxUbJmYenikufQQ9txIMEfkreAz58-Sw4&callback=initMap"></script>
